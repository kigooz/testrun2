...
unlocked to sign the EarthDollar-Qt.app bundle.
...
allowing somebody to distribute a EarthDollar-Qt.app or EarthDollar-qt-setup.exe with a valid
...
that the EarthDollar-qt.exe file inside the installer had not been tampered with.
