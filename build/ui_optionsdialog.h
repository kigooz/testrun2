...
public:
    ...
    QCheckBox *EarthDollarAtStartup;
    ...
    EarthDollarAmountField *transactionFee;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        EarthDollarAtStartup = new QCheckBox(tabMain);
        EarthDollarAtStartup->setObjectName(QString::fromUtf8("EarthDollarAtStartup"));

        verticalLayout_Main->addWidget(EarthDollarAtStartup);
        ...
        transactionFee = new EarthDollarAmountField(tabWallet);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        EarthDollarAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start EarthDollar after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        EarthDollarAtStartup->setText(QApplication::translate("OptionsDialog", "&Start EarthDollar on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the EarthDollar client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the EarthDollar network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting EarthDollar.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show EarthDollar addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
