#############################################################################
# Makefile for building: EarthDollar-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu May 21 18:26:29 2015
# Project:  EarthDollar-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_UPNP=- -o Makefile EarthDollar-qt.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -ID:/deps/boost_1_55_n -ID:/deps/db-4.8.30.NC/build_unix -ID:/deps/openssl-1.0.1g/include -ID:/deps/qrencode-3.4.3 -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu /home/kigooz/test/testrun/src/leveldb/libleveldb.a /home/kigooz/test/testrun/src/leveldb/libmemenv.a -lrt -LD:/deps/boost_1_55_n/stage/lib -LD:/deps/db-4.8.30.NC/build_unix -LD:/deps/openssl-1.0.1g -LD:/deps/qrencode-3.4.3/.libs -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/qt/EarthDollar.cpp \
		...
		src/leveldb.cpp \
		src/txdb.cpp \
		src/qt/splashscreen.cpp build/moc_EarthDollargui.cpp \
		...
		build/moc_EarthDollaraddressvalidator.cpp \
		...
		build/moc_EarthDollaramountfield.cpp \
		...
		build/moc_EarthDollarunits.cpp \
		...
		qrc_EarthDollar.cpp
OBJECTS       = build/EarthDollar.o \
		build/EarthDollargui.o \
		...
		build/EarthDollaraddressvalidator.o \
		build/alert.o \
		build/version.o \
		build/sync.o \
		build/util.o \
		...
		build/EarthDollarstrings.o \
		build/EarthDollaramountfield.o \
		build/wallet.o \
		build/keystore.o \
		...
		build/moc_EarthDollaraddressvalidator.o \
		...
		build/moc_EarthDollaramountfield.o \
...
$(TARGET): /home/kigooz/test/testrun/src/leveldb/libleveldb.a /home/kigooz/test/testrun/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: EarthDollar-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile EarthDollar-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/EarthDollar-qt0.8.7.4 || $(MKDIR) build/EarthDollar-qt0.8.7.4 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/EarthDollar-qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/locale/EarthDollar_af_ZA.ts src/qt/locale/EarthDollar_ar.ts src/qt/locale/EarthDollar_bg.ts src/qt/locale/EarthDollar_bs.ts src/qt/locale/EarthDollar_ca.ts src/qt/locale/EarthDollar_ca_ES.ts src/qt/locale/EarthDollar_cs.ts src/qt/locale/EarthDollar_cy.ts src/qt/locale/EarthDollar_da.ts src/qt/locale/EarthDollar_de.ts src/qt/locale/EarthDollar_el_GR.ts src/qt/locale/EarthDollar_en.ts src/qt/locale/EarthDollar_eo.ts src/qt/locale/EarthDollar_es.ts src/qt/locale/EarthDollar_es_CL.ts src/qt/locale/EarthDollar_et.ts src/qt/locale/EarthDollar_eu_ES.ts src/qt/locale/EarthDollar_fa.ts src/qt/locale/EarthDollar_fa_IR.ts src/qt/locale/EarthDollar_fi.ts src/qt/locale/EarthDollar_fr.ts src/qt/locale/EarthDollar_fr_CA.ts src/qt/locale/EarthDollar_gu_IN.ts src/qt/locale/EarthDollar_he.ts src/qt/locale/EarthDollar_hi_IN.ts src/qt/locale/EarthDollar_hr.ts src/qt/locale/EarthDollar_hu.ts src/qt/locale/EarthDollar_it.ts src/qt/locale/EarthDollar_ja.ts src/qt/locale/EarthDollar_la.ts src/qt/locale/EarthDollar_lt.ts src/qt/locale/EarthDollar_lv_LV.ts src/qt/locale/EarthDollar_nb.ts src/qt/locale/EarthDollar_nl.ts src/qt/locale/EarthDollar_pl.ts src/qt/locale/EarthDollar_pt_BR.ts src/qt/locale/EarthDollar_pt_PT.ts src/qt/locale/EarthDollar_ro_RO.ts src/qt/locale/EarthDollar_ru.ts src/qt/locale/EarthDollar_sk.ts src/qt/locale/EarthDollar_sr.ts src/qt/locale/EarthDollar_sv.ts src/qt/locale/EarthDollar_th_TH.ts src/qt/locale/EarthDollar_tr.ts src/qt/locale/EarthDollar_uk.ts src/qt/locale/EarthDollar_zh_CN.ts src/qt/locale/EarthDollar_zh_TW.ts build/EarthDollar-qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/EarthDollargui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/EarthDollaraddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/EarthDollaramountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/EarthDollarrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/EarthDollarunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/scrypt.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h build/EarthDollar-qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/EarthDollar.qrc build/EarthDollar-qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/EarthDollar.cpp src/qt/EarthDollargui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/EarthDollaraddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/EarthDollarstrings.cpp src/qt/EarthDollaramountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/EarthDollarrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/EarthDollarunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/scrypt.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp build/EarthDollar-qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/EarthDollar-qt0.8.7.4/ && $(COPY_FILE) --parents src/qt/locale/EarthDollar_af_ZA.ts src/qt/locale/EarthDollar_ar.ts src/qt/locale/EarthDollar_bg.ts src/qt/locale/EarthDollar_bs.ts src/qt/locale/EarthDollar_ca.ts src/qt/locale/EarthDollar_ca_ES.ts src/qt/locale/EarthDollar_cs.ts src/qt/locale/EarthDollar_cy.ts src/qt/locale/EarthDollar_da.ts src/qt/locale/EarthDollar_de.ts src/qt/locale/EarthDollar_el_GR.ts src/qt/locale/EarthDollar_en.ts src/qt/locale/EarthDollar_eo.ts src/qt/locale/EarthDollar_es.ts src/qt/locale/EarthDollar_es_CL.ts src/qt/locale/EarthDollar_et.ts src/qt/locale/EarthDollar_eu_ES.ts src/qt/locale/EarthDollar_fa.ts src/qt/locale/EarthDollar_fa_IR.ts src/qt/locale/EarthDollar_fi.ts src/qt/locale/EarthDollar_fr.ts src/qt/locale/EarthDollar_fr_CA.ts src/qt/locale/EarthDollar_gu_IN.ts src/qt/locale/EarthDollar_he.ts src/qt/locale/EarthDollar_hi_IN.ts src/qt/locale/EarthDollar_hr.ts src/qt/locale/EarthDollar_hu.ts src/qt/locale/EarthDollar_it.ts src/qt/locale/EarthDollar_ja.ts src/qt/locale/EarthDollar_la.ts src/qt/locale/EarthDollar_lt.ts src/qt/locale/EarthDollar_lv_LV.ts src/qt/locale/EarthDollar_nb.ts src/qt/locale/EarthDollar_nl.ts src/qt/locale/EarthDollar_pl.ts src/qt/locale/EarthDollar_pt_BR.ts src/qt/locale/EarthDollar_pt_PT.ts src/qt/locale/EarthDollar_ro_RO.ts src/qt/locale/EarthDollar_ru.ts src/qt/locale/EarthDollar_sk.ts src/qt/locale/EarthDollar_sr.ts src/qt/locale/EarthDollar_sv.ts src/qt/locale/EarthDollar_th_TH.ts src/qt/locale/EarthDollar_tr.ts src/qt/locale/EarthDollar_uk.ts src/qt/locale/EarthDollar_zh_CN.ts src/qt/locale/EarthDollar_zh_TW.ts build/EarthDollar-qt0.8.7.4/ && (cd `dirname build/EarthDollar-qt0.8.7.4` && $(TAR) EarthDollar-qt0.8.7.4.tar EarthDollar-qt0.8.7.4 && $(COMPRESS) EarthDollar-qt0.8.7.4.tar) && $(MOVE) `dirname build/EarthDollar-qt0.8.7.4`/EarthDollar-qt0.8.7.4.tar.gz . && $(DEL_FILE) -r build/EarthDollar-qt0.8.7.4


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/kigooz/test/testrun/src/leveldb/libleveldb.a; cd /home/kigooz/test/testrun/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/kigooz/test/testrun/src/leveldb/libleveldb.a: FORCE
	cd /home/kigooz/test/testrun/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/kigooz/test/testrun/build/build.h: FORCE
	cd /home/kigooz/test/testrun; /bin/sh share/genbuild.sh /home/kigooz/test/testrun/build/build.h
...
compiler_TSQM_make_all: src/qt/locale/EarthDollar_af_ZA.qm src/qt/locale/EarthDollar_ar.qm src/qt/locale/EarthDollar_bg.qm src/qt/locale/EarthDollar_bs.qm src/qt/locale/EarthDollar_ca.qm src/qt/locale/EarthDollar_ca_ES.qm src/qt/locale/EarthDollar_cs.qm src/qt/locale/EarthDollar_cy.qm src/qt/locale/EarthDollar_da.qm src/qt/locale/EarthDollar_de.qm src/qt/locale/EarthDollar_el_GR.qm src/qt/locale/EarthDollar_en.qm src/qt/locale/EarthDollar_eo.qm src/qt/locale/EarthDollar_es.qm src/qt/locale/EarthDollar_es_CL.qm src/qt/locale/EarthDollar_et.qm src/qt/locale/EarthDollar_eu_ES.qm src/qt/locale/EarthDollar_fa.qm src/qt/locale/EarthDollar_fa_IR.qm src/qt/locale/EarthDollar_fi.qm src/qt/locale/EarthDollar_fr.qm src/qt/locale/EarthDollar_fr_CA.qm src/qt/locale/EarthDollar_gu_IN.qm src/qt/locale/EarthDollar_he.qm src/qt/locale/EarthDollar_hi_IN.qm src/qt/locale/EarthDollar_hr.qm src/qt/locale/EarthDollar_hu.qm src/qt/locale/EarthDollar_it.qm src/qt/locale/EarthDollar_ja.qm src/qt/locale/EarthDollar_la.qm src/qt/locale/EarthDollar_lt.qm src/qt/locale/EarthDollar_lv_LV.qm src/qt/locale/EarthDollar_nb.qm src/qt/locale/EarthDollar_nl.qm src/qt/locale/EarthDollar_pl.qm src/qt/locale/EarthDollar_pt_BR.qm src/qt/locale/EarthDollar_pt_PT.qm src/qt/locale/EarthDollar_ro_RO.qm src/qt/locale/EarthDollar_ru.qm src/qt/locale/EarthDollar_sk.qm src/qt/locale/EarthDollar_sr.qm src/qt/locale/EarthDollar_sv.qm src/qt/locale/EarthDollar_th_TH.qm src/qt/locale/EarthDollar_tr.qm src/qt/locale/EarthDollar_uk.qm src/qt/locale/EarthDollar_zh_CN.qm src/qt/locale/EarthDollar_zh_TW.qm
compiler_TSQM_clean:
	-$(DEL_FILE) src/qt/locale/EarthDollar_af_ZA.qm src/qt/locale/EarthDollar_ar.qm src/qt/locale/EarthDollar_bg.qm src/qt/locale/EarthDollar_bs.qm src/qt/locale/EarthDollar_ca.qm src/qt/locale/EarthDollar_ca_ES.qm src/qt/locale/EarthDollar_cs.qm src/qt/locale/EarthDollar_cy.qm src/qt/locale/EarthDollar_da.qm src/qt/locale/EarthDollar_de.qm src/qt/locale/EarthDollar_el_GR.qm src/qt/locale/EarthDollar_en.qm src/qt/locale/EarthDollar_eo.qm src/qt/locale/EarthDollar_es.qm src/qt/locale/EarthDollar_es_CL.qm src/qt/locale/EarthDollar_et.qm src/qt/locale/EarthDollar_eu_ES.qm src/qt/locale/EarthDollar_fa.qm src/qt/locale/EarthDollar_fa_IR.qm src/qt/locale/EarthDollar_fi.qm src/qt/locale/EarthDollar_fr.qm src/qt/locale/EarthDollar_fr_CA.qm src/qt/locale/EarthDollar_gu_IN.qm src/qt/locale/EarthDollar_he.qm src/qt/locale/EarthDollar_hi_IN.qm src/qt/locale/EarthDollar_hr.qm src/qt/locale/EarthDollar_hu.qm src/qt/locale/EarthDollar_it.qm src/qt/locale/EarthDollar_ja.qm src/qt/locale/EarthDollar_la.qm src/qt/locale/EarthDollar_lt.qm src/qt/locale/EarthDollar_lv_LV.qm src/qt/locale/EarthDollar_nb.qm src/qt/locale/EarthDollar_nl.qm src/qt/locale/EarthDollar_pl.qm src/qt/locale/EarthDollar_pt_BR.qm src/qt/locale/EarthDollar_pt_PT.qm src/qt/locale/EarthDollar_ro_RO.qm src/qt/locale/EarthDollar_ru.qm src/qt/locale/EarthDollar_sk.qm src/qt/locale/EarthDollar_sr.qm src/qt/locale/EarthDollar_sv.qm src/qt/locale/EarthDollar_th_TH.qm src/qt/locale/EarthDollar_tr.qm src/qt/locale/EarthDollar_uk.qm src/qt/locale/EarthDollar_zh_CN.qm src/qt/locale/EarthDollar_zh_TW.qm
src/qt/locale/EarthDollar_af_ZA.qm: src/qt/locale/EarthDollar_af_ZA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_af_ZA.ts -qm src/qt/locale/EarthDollar_af_ZA.qm

src/qt/locale/EarthDollar_ar.qm: src/qt/locale/EarthDollar_ar.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_ar.ts -qm src/qt/locale/EarthDollar_ar.qm

src/qt/locale/EarthDollar_bg.qm: src/qt/locale/EarthDollar_bg.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_bg.ts -qm src/qt/locale/EarthDollar_bg.qm

src/qt/locale/EarthDollar_bs.qm: src/qt/locale/EarthDollar_bs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_bs.ts -qm src/qt/locale/EarthDollar_bs.qm

src/qt/locale/EarthDollar_ca.qm: src/qt/locale/EarthDollar_ca.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_ca.ts -qm src/qt/locale/EarthDollar_ca.qm

src/qt/locale/EarthDollar_ca_ES.qm: src/qt/locale/EarthDollar_ca_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_ca_ES.ts -qm src/qt/locale/EarthDollar_ca_ES.qm

src/qt/locale/EarthDollar_cs.qm: src/qt/locale/EarthDollar_cs.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_cs.ts -qm src/qt/locale/EarthDollar_cs.qm

src/qt/locale/EarthDollar_cy.qm: src/qt/locale/EarthDollar_cy.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_cy.ts -qm src/qt/locale/EarthDollar_cy.qm

src/qt/locale/EarthDollar_da.qm: src/qt/locale/EarthDollar_da.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_da.ts -qm src/qt/locale/EarthDollar_da.qm

src/qt/locale/EarthDollar_de.qm: src/qt/locale/EarthDollar_de.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_de.ts -qm src/qt/locale/EarthDollar_de.qm

src/qt/locale/EarthDollar_el_GR.qm: src/qt/locale/EarthDollar_el_GR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_el_GR.ts -qm src/qt/locale/EarthDollar_el_GR.qm

src/qt/locale/EarthDollar_en.qm: src/qt/locale/EarthDollar_en.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_en.ts -qm src/qt/locale/EarthDollar_en.qm

src/qt/locale/EarthDollar_eo.qm: src/qt/locale/EarthDollar_eo.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_eo.ts -qm src/qt/locale/EarthDollar_eo.qm

src/qt/locale/EarthDollar_es.qm: src/qt/locale/EarthDollar_es.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_es.ts -qm src/qt/locale/EarthDollar_es.qm

src/qt/locale/EarthDollar_es_CL.qm: src/qt/locale/EarthDollar_es_CL.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_es_CL.ts -qm src/qt/locale/EarthDollar_es_CL.qm

src/qt/locale/EarthDollar_et.qm: src/qt/locale/EarthDollar_et.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_et.ts -qm src/qt/locale/EarthDollar_et.qm

src/qt/locale/EarthDollar_eu_ES.qm: src/qt/locale/EarthDollar_eu_ES.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_eu_ES.ts -qm src/qt/locale/EarthDollar_eu_ES.qm

src/qt/locale/EarthDollar_fa.qm: src/qt/locale/EarthDollar_fa.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_fa.ts -qm src/qt/locale/EarthDollar_fa.qm

src/qt/locale/EarthDollar_fa_IR.qm: src/qt/locale/EarthDollar_fa_IR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_fa_IR.ts -qm src/qt/locale/EarthDollar_fa_IR.qm

src/qt/locale/EarthDollar_fi.qm: src/qt/locale/EarthDollar_fi.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_fi.ts -qm src/qt/locale/EarthDollar_fi.qm

src/qt/locale/EarthDollar_fr.qm: src/qt/locale/EarthDollar_fr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_fr.ts -qm src/qt/locale/EarthDollar_fr.qm

src/qt/locale/EarthDollar_fr_CA.qm: src/qt/locale/EarthDollar_fr_CA.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_fr_CA.ts -qm src/qt/locale/EarthDollar_fr_CA.qm

src/qt/locale/EarthDollar_gu_IN.qm: src/qt/locale/EarthDollar_gu_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_gu_IN.ts -qm src/qt/locale/EarthDollar_gu_IN.qm

src/qt/locale/EarthDollar_he.qm: src/qt/locale/EarthDollar_he.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_he.ts -qm src/qt/locale/EarthDollar_he.qm

src/qt/locale/EarthDollar_hi_IN.qm: src/qt/locale/EarthDollar_hi_IN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_hi_IN.ts -qm src/qt/locale/EarthDollar_hi_IN.qm

src/qt/locale/EarthDollar_hr.qm: src/qt/locale/EarthDollar_hr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_hr.ts -qm src/qt/locale/EarthDollar_hr.qm

src/qt/locale/EarthDollar_hu.qm: src/qt/locale/EarthDollar_hu.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_hu.ts -qm src/qt/locale/EarthDollar_hu.qm

src/qt/locale/EarthDollar_it.qm: src/qt/locale/EarthDollar_it.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_it.ts -qm src/qt/locale/EarthDollar_it.qm

src/qt/locale/EarthDollar_ja.qm: src/qt/locale/EarthDollar_ja.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_ja.ts -qm src/qt/locale/EarthDollar_ja.qm

src/qt/locale/EarthDollar_la.qm: src/qt/locale/EarthDollar_la.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_la.ts -qm src/qt/locale/EarthDollar_la.qm

src/qt/locale/EarthDollar_lt.qm: src/qt/locale/EarthDollar_lt.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_lt.ts -qm src/qt/locale/EarthDollar_lt.qm

src/qt/locale/EarthDollar_lv_LV.qm: src/qt/locale/EarthDollar_lv_LV.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_lv_LV.ts -qm src/qt/locale/EarthDollar_lv_LV.qm

src/qt/locale/EarthDollar_nb.qm: src/qt/locale/EarthDollar_nb.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_nb.ts -qm src/qt/locale/EarthDollar_nb.qm

src/qt/locale/EarthDollar_nl.qm: src/qt/locale/EarthDollar_nl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_nl.ts -qm src/qt/locale/EarthDollar_nl.qm

src/qt/locale/EarthDollar_pl.qm: src/qt/locale/EarthDollar_pl.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_pl.ts -qm src/qt/locale/EarthDollar_pl.qm

src/qt/locale/EarthDollar_pt_BR.qm: src/qt/locale/EarthDollar_pt_BR.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_pt_BR.ts -qm src/qt/locale/EarthDollar_pt_BR.qm

src/qt/locale/EarthDollar_pt_PT.qm: src/qt/locale/EarthDollar_pt_PT.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_pt_PT.ts -qm src/qt/locale/EarthDollar_pt_PT.qm

src/qt/locale/EarthDollar_ro_RO.qm: src/qt/locale/EarthDollar_ro_RO.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_ro_RO.ts -qm src/qt/locale/EarthDollar_ro_RO.qm

src/qt/locale/EarthDollar_ru.qm: src/qt/locale/EarthDollar_ru.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_ru.ts -qm src/qt/locale/EarthDollar_ru.qm

src/qt/locale/EarthDollar_sk.qm: src/qt/locale/EarthDollar_sk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_sk.ts -qm src/qt/locale/EarthDollar_sk.qm

src/qt/locale/EarthDollar_sr.qm: src/qt/locale/EarthDollar_sr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_sr.ts -qm src/qt/locale/EarthDollar_sr.qm

src/qt/locale/EarthDollar_sv.qm: src/qt/locale/EarthDollar_sv.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_sv.ts -qm src/qt/locale/EarthDollar_sv.qm

src/qt/locale/EarthDollar_th_TH.qm: src/qt/locale/EarthDollar_th_TH.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_th_TH.ts -qm src/qt/locale/EarthDollar_th_TH.qm

src/qt/locale/EarthDollar_tr.qm: src/qt/locale/EarthDollar_tr.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_tr.ts -qm src/qt/locale/EarthDollar_tr.qm

src/qt/locale/EarthDollar_uk.qm: src/qt/locale/EarthDollar_uk.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_uk.ts -qm src/qt/locale/EarthDollar_uk.qm

src/qt/locale/EarthDollar_zh_CN.qm: src/qt/locale/EarthDollar_zh_CN.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_zh_CN.ts -qm src/qt/locale/EarthDollar_zh_CN.qm

src/qt/locale/EarthDollar_zh_TW.qm: src/qt/locale/EarthDollar_zh_TW.ts
	/usr/lib/x86_64-linux-gnu/qt4/bin/lrelease src/qt/locale/EarthDollar_zh_TW.ts -qm src/qt/locale/EarthDollar_zh_TW.qm

compiler_moc_header_make_all: build/moc_EarthDollargui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_EarthDollaraddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_EarthDollaramountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_walletview.cpp build/moc_walletstack.cpp build/moc_walletframe.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_EarthDollarunits.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_paymentserver.cpp build/moc_rpcconsole.cpp build/moc_macnotificationhandler.cpp build/moc_splashscreen.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_EarthDollargui.cpp build/moc_transactiontablemodel.cpp build/moc_addresstablemodel.cpp build/moc_optionsdialog.cpp build/moc_sendcoinsdialog.cpp build/moc_coincontroldialog.cpp build/moc_coincontroltreewidget.cpp build/moc_addressbookpage.cpp build/moc_signverifymessagedialog.cpp build/moc_aboutdialog.cpp build/moc_editaddressdialog.cpp build/moc_EarthDollaraddressvalidator.cpp build/moc_clientmodel.cpp build/moc_guiutil.cpp build/moc_optionsmodel.cpp build/moc_monitoreddatamapper.cpp build/moc_transactiondesc.cpp build/moc_transactiondescdialog.cpp build/moc_EarthDollaramountfield.cpp build/moc_transactionfilterproxy.cpp build/moc_transactionview.cpp build/moc_walletmodel.cpp build/moc_walletview.cpp build/moc_walletstack.cpp build/moc_walletframe.cpp build/moc_overviewpage.cpp build/moc_csvmodelwriter.cpp build/moc_sendcoinsentry.cpp build/moc_qvalidatedlineedit.cpp build/moc_EarthDollarunits.cpp build/moc_qvaluecombobox.cpp build/moc_askpassphrasedialog.cpp build/moc_notificator.cpp build/moc_paymentserver.cpp build/moc_rpcconsole.cpp build/moc_macnotificationhandler.cpp build/moc_splashscreen.cpp
build/moc_EarthDollargui.cpp: src/qt/EarthDollargui.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/EarthDollargui.h -o build/moc_EarthDollargui.cpp
...
build/moc_EarthDollaraddressvalidator.cpp: src/qt/EarthDollaraddressvalidator.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/EarthDollaraddressvalidator.h -o build/moc_EarthDollaraddressvalidator.cpp
...
build/moc_EarthDollaramountfield.cpp: src/qt/EarthDollaramountfield.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/EarthDollaramountfield.h -o build/moc_EarthDollaramountfield.cpp
...
build/moc_EarthDollarunits.cpp: src/qt/EarthDollarunits.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/EarthDollarunits.h -o build/moc_EarthDollarunits.cpp
...
compiler_rcc_make_all: qrc_EarthDollar.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_EarthDollar.cpp
qrc_EarthDollar.cpp: src/qt/EarthDollar.qrc \
		src/qt/locale/EarthDollar_fr.qm \
		src/qt/locale/EarthDollar_sk.qm \
		src/qt/locale/EarthDollar_ca.ts \
		src/qt/locale/EarthDollar_bs.ts \
		src/qt/locale/EarthDollar_sr.qm \
		src/qt/locale/EarthDollar_hi_IN.ts \
		src/qt/locale/EarthDollar_sv.qm \
		src/qt/locale/EarthDollar_la.ts \
		src/qt/locale/EarthDollar_pt_BR.qm \
		src/qt/locale/EarthDollar_da.qm \
		src/qt/locale/EarthDollar_zh_CN.qm \
		src/qt/locale/EarthDollar_he.qm \
		src/qt/locale/EarthDollar_pl.qm \
		src/qt/locale/EarthDollar_cs.qm \
		src/qt/locale/EarthDollar_lv_LV.ts \
		src/qt/locale/EarthDollar_de.qm \
		src/qt/locale/EarthDollar_th_TH.ts \
		src/qt/locale/EarthDollar_tr.qm \
		src/qt/locale/EarthDollar_cy.ts \
		src/qt/locale/EarthDollar_eu_ES.qm \
		src/qt/locale/EarthDollar_fr_CA.qm \
		src/qt/locale/EarthDollar_ca_ES.qm \
		src/qt/locale/EarthDollar_lt.qm \
		src/qt/locale/EarthDollar_zh_TW.qm \
		src/qt/locale/EarthDollar_hr.qm \
		src/qt/locale/EarthDollar_uk.qm \
		src/qt/locale/EarthDollar_hu.qm \
		src/qt/locale/EarthDollar_af_ZA.qm \
		src/qt/locale/EarthDollar_es_CL.qm \
		src/qt/locale/EarthDollar_pt_PT.qm \
		src/qt/locale/EarthDollar_gu_IN.ts \
		src/qt/locale/EarthDollar_ro_RO.qm \
		src/qt/locale/EarthDollar_nb.qm \
		src/qt/locale/EarthDollar_el_GR.qm \
		src/qt/locale/EarthDollar_ja.ts \
		src/qt/locale/EarthDollar_en.qm \
		src/qt/locale/EarthDollar_eo.ts \
		src/qt/locale/EarthDollar_it.qm \
		src/qt/locale/EarthDollar_fa.qm \
		src/qt/locale/EarthDollar_es.qm \
		src/qt/locale/EarthDollar_et.qm \
		src/qt/locale/EarthDollar_ar.qm \
		src/qt/locale/EarthDollar_nl.qm \
		src/qt/locale/EarthDollar_fa_IR.qm \
		src/qt/locale/EarthDollar_fi.qm \
		src/qt/locale/EarthDollar_bg.qm \
		src/qt/locale/EarthDollar_ru.qm \
		...
		src/qt/res/icons/EarthDollar.png \
		...
		src/qt/res/icons/EarthDollar_testnet.png \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/rcc -name EarthDollar src/qt/EarthDollar.qrc -o qrc_EarthDollar.cpp
...
build/EarthDollar.o: src/qt/EarthDollar.cpp src/qt/EarthDollargui.h \
		src/qt/clientmodel.h \
		src/qt/walletmodel.h \
		src/allocators.h \
		src/qt/optionsmodel.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollar.o src/qt/EarthDollar.cpp

build/EarthDollargui.o: src/qt/EarthDollargui.cpp src/qt/EarthDollargui.h \
		src/qt/transactiontablemodel.h \
		...
		src/init.h \
		src/qt/macdockiconhandler.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollargui.o src/qt/EarthDollargui.cpp
...
build/EarthDollaraddressvalidator.o: src/qt/EarthDollaraddressvalidator.cpp src/qt/EarthDollaraddressvalidator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollaraddressvalidator.o src/qt/EarthDollaraddressvalidator.cpp
...
build/EarthDollarstrings.o: src/qt/EarthDollarstrings.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollarstrings.o src/qt/EarthDollarstrings.cpp

build/EarthDollaramountfield.o: src/qt/EarthDollaramountfield.cpp src/qt/EarthDollaramountfield.h \
		src/qt/qvaluecombobox.h \
		src/qt/EarthDollarunits.h \
		src/qt/guiconstants.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollaramountfield.o src/qt/EarthDollaramountfield.cpp
...
build/EarthDollarrpc.o: src/EarthDollarrpc.cpp src/init.h \
		src/wallet.h \
		src/main.h \
		src/bignum.h \
		src/util.h \
		...
		src/json/json_spirit_writer_template.h \
		src/json/json_spirit_utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollarrpc.o src/EarthDollarrpc.cpp
...
build/EarthDollarunits.o: src/qt/EarthDollarunits.cpp src/qt/EarthDollarunits.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/EarthDollarunits.o src/qt/EarthDollarunits.cpp
...
build/moc_EarthDollargui.o: build/moc_EarthDollargui.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_EarthDollargui.o build/moc_EarthDollargui.cpp
...
build/moc_EarthDollaraddressvalidator.o: build/moc_EarthDollaraddressvalidator.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_EarthDollaraddressvalidator.o build/moc_EarthDollaraddressvalidator.cpp
...
build/moc_EarthDollaramountfield.o: build/moc_EarthDollaramountfield.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_EarthDollaramountfield.o build/moc_EarthDollaramountfield.cpp
...
build/moc_EarthDollarunits.o: build/moc_EarthDollarunits.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_EarthDollarunits.o build/moc_EarthDollarunits.cpp
...
build/qrc_EarthDollar.o: qrc_EarthDollar.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/qrc_EarthDollar.o qrc_EarthDollar.cpp
