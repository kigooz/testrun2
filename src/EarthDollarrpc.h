...
#ifndef _EarthDollarRPC_H_
#define _EarthDollarRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // EarthDollar is not connected
...
/**
 * EarthDollar RPC command dispatcher.
 */
class CRPCTable
{
private:
