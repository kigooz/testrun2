...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("EarthDollar-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EarthDollar " + FormatFullVersion();
...
//mainnet node was  {"node1.cryptofactory.in", "node1.cryptofactory.in"},
// testnet nodes were {"EarthDollartools.com", "testnet-seed.EarthDollartools.com"},
//    {"xurious.com", "testnet-seed.ED.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EarthDollar is probably already running."), addrBind.ToString().c_str());
        else
