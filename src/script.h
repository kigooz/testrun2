...
#ifndef H_EarthDollar_SCRIPT
#define H_EarthDollar_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEarthDollarAddress
 */
...
public:
    ...
    // Pre-version-0.6, EarthDollar always counted CHECKMULTISIGs
