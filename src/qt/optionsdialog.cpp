    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new EarthDollarUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->EarthDollarAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting EarthDollar."), QMessageBox::Ok);
